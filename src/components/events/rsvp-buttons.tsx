    ...
    <div className="flex flex-wrap gap-4">
      <Button 
        ...
        className={cn(
          ...
          status === 'YES' ? "bg-primary shadow-lg shadow-primary/30" : "bg-primary/20 text-primary hover:bg-primary/30"
        )}
      >
        {loading === 'YES' ? "Wait..." : (
          <>
      ...
      <Button 
        ...
        className={cn(
          ...
          status === 'NO' ? "bg-destructive text-white border-destructive shadow-lg shadow-destructive/30" : "glass hover:bg-white/10"
        )}
      >
        {loading === 'NO' ? "Wait..." : (
          <>
